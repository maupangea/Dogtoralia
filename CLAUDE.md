...
│   ├── Controllers/        # ClinicsController, PetsController, HomeController
│   ├── Data/               # DogtoraliaDbContext
│   ├── Helpers/            # PaginatedList<T>
│   ├── Migrations/         # EF migrations (auto-generated)
│   ├── Models/             # Speciality, Clinic, Veterinarian, Pet
│   ├── ViewModels/         # ClinicsIndexViewModel, ClinicFormViewModel, PetsIndexViewModel, PetFormViewModel
│   ├── Views/              # Clinics/, Pets/, Shared/, Home/
...
└── DogtoraliaMVC.Tests/    # xUnit tests (net10.0)
    ├── Controllers/        # ClinicsControllerTests, PetsControllerTests
...
- `_Layout.cshtml` — navbar includes Home, Clinics, Pets, Privacy
...
- **43 tests total:** controller CRUD (Create/Read/Update/Delete GET+POST), pagination helper, and seed data integrity.
